...
"""Verify that starting playcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start playcoin with -h for help text")
        ...
        self.log.info("Start playcoin with -version for version information")
        ...
        self.log.info("Start playcoind with -fakearg to make sure it does not start")
