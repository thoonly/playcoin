# Support for Output Descriptors in Playcoin Core

Since Playcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Playcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Playcoin Core wallets, a convenience function `combo` is
