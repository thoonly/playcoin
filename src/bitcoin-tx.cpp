...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " playcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  playcoin-tx [options] <hex-tx> [commands]  Update hex-encoded playcoin transaction\n" +
            "or:     playcoin-tx [options] -create [commands]   Create hex-encoded playcoin transaction\n" +
            "\n";
