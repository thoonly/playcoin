...
const char * const BITCOIN_CONF_FILENAME = "playcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Playcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Playcoin";
#else
    // Unix
    return pathRet / ".playcoin";
#endif
#endif
}
